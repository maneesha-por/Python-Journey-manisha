# Python-Journey-manisha
This repository contains my Python learning progress and daily code exercises.❤️‍🔥❤️‍🔥❤️‍🔥

​# 🐍 Python Journey - Manisha

This repository contains my Python learning progress and daily code exercises. 🔥🔥🔥

## 📝 Day 01 Summary Report
...
* **Code:** `shares = 100`
* **Key Terms:** Variable Name (`shares`), Assignment Operator (`=`), Value (`100`).
